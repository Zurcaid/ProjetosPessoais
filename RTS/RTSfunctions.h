...
King NoviceKing(0, 1, 70, 10, 10, 50, 10, "The Novice King"), ProphesiedKing(0, 1, 70, 300, 300, 75, 10000, "The Prophesied King"), KingOfKings(0, 20, 130, 1000, 1000, 50, 0, "The King of Kings"),
    Conqueror(0, 30, 90, 100, 100, 50, 200000, "The Conqueror"), GodEmperor(1, 100, 500, 500, 500, 50, 10000, "The God Emperor of Mankind"),
    BringerOfLight(1, 20, 80, 1000, 100, 100, 1000, "The Prophesied Bringer of Light"), Tyrant(0, 45, 75, 250, 180, 10, 8500, "The Tyrant King"),
    Wise(0, 60, 85, 120, 70, 90, 5000, "The Wise King"), Undying(0, 499, 10000, 600, 150, 30, 2000, "The Undying King"),
    IronFist(0, 30, 78, 100, 500, 25, 12000, "The Iron Fist"), Golden(0, 28, 65, 180, 90, 60, 6000, "The Golden King"),
    Exiled(0, 39, 70, 220, 140, 45, 1500, "The Exiled King"), MadKing(0, 55, 60, 150, 110, 5, 4000, "The Mad King"),
    DragonBorn(0, 24, 150, 450, 350, 65, 9000, "The Dragonborn King"), TheJust(0, 41, 82, 200, 100, 95, 7500, "The Just Ruler"),
    Cruel(0, 61, 72, 170, 130, 8, 5500, "The Cruel"), YoungLion(0, 18, 85, 280, 190, 70, 8000, "The Young Lion"),
    OldOak(0, 83, 95, 140, 60, 85, 4500, "The Old Oak"), Bloodstained(0, 48, 68, 380, 280, 12, 14000, "The Bloodstained King"),
    Saint(0, 52, 88, 210, 80, 100, 6500, "The Saint King"), SeaLord(0, 35, 75, 260, 160, 55, 11000, "The Sea King");
